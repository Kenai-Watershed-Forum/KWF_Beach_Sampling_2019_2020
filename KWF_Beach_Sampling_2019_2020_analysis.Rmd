...
excd_tbl %>%
  filter(Year == "2020") %>%
  write.csv("output/exceedance_table.csv", row.names = F)
...
# save
ggsave("output/fc_indv.png", width = 26, height = 16, units = "cm")
...
# save
ggsave("output/fc_geomean.png", width = 26, height = 16, units = "cm")
...
# save
ggsave("output/ec_indv.png", width = 26, height = 16, units = "cm")
```
...
# save
ggsave("output/ec_geomean.png", width = 26, height = 16, units = "cm")
...
theme(legend.direction = "vertical",
  ...
  scale_color_discrete(name="Exceedance Type (CFU/100 mL)",
                      ...
                      labels = c("Contact Recreation Advisory (Enterococci > 130)",
                                 ...
                                 "Harvesting Seafood for Raw Consumption (Fecal Coliform > 31)",
